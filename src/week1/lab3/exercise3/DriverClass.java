...
public class DriverClass {
	...
	public static void main(String[] args) {
		...
		ceo.addInferior(marketingDeptHead);
		ceo.addInferior(salesDeptHead);
		
		salesManager1.setSuperior(salesDeptHead);
		salesManager2.setSuperior(salesDeptHead);
		
		marketer1.setSuperior(marketingDeptHead);
		
		salesManager1.addInferior(salesPerson1);
		salesManager1.addInferior(salesPerson2);
		salesManager1.addInferior(salesPerson3);
		
		salesManager2.addInferior(salesPerson4);
